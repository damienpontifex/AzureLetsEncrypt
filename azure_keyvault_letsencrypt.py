...
from functions.CertExpiryEventTrigger.key_vault_rsa_key import KeyVaultRSAKey
from functions.CertExpiryEventTrigger.azure_dns import dns_challenge_handler
...
kv_cert_name = 'testdamienpontifexcom'
domains = certs[kv_cert_name]
use_prod = False
